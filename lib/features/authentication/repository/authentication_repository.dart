...
import 'package:advanced_todo_app/features/todo/views/home_screen.dart';
  ...
  Future<void> verifyOTP({
    ...
    try {
      ...
      if (userCredential.user != null) {
        ...
        showSnack('Error Occured, Failed to Sign up');
      }
      ...
      CoreUtils.showSnackBar(
          context: context, message: '505 : Error');
    }
  }
}
